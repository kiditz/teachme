package com.slerpio.view.editor;
...
//            });
    ...
    public void insertImage(URI url, String alt) {
        exec("javascript:RE.prepareInsert();");
        exec("javascript:RE.insertImage('" + url + "', '" + alt + "');");
    }

    public void insertImageBase64(String mimeType, String data) {
        exec("javascript:RE.prepareInsert();");
        exec("javascript:RE.insertImageBase64('" + mimeType + "', '" + data + "');");
    }
